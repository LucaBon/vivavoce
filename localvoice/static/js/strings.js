...
export const UI_EN = {
  ...
  pro_err_save: "Activated, but it could not be saved here. Check the disk and try again.",
...
export const UI_IT = {
  ...
  pro_err_save: "Attivata, ma non sono riuscito a salvarla qui. Controlla il disco e riprova.",
